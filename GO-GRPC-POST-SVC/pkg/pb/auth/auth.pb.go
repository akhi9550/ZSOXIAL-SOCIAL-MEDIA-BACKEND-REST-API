...
var file_pkg_pb_auth_auth_proto_rawDesc = []byte{
	...
	0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x32, 0xcc, 0x03, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x83, 0x01, 0x0a, 0x20, 0x43, 0x68, 0x65, 0x63, 0x6b,
...
var file_pkg_pb_auth_auth_proto_depIdxs = []int32{
	...
	0, // 3: user.AuthService.CheckUserAvalilabilityWithUserID:input_type -> user.CheckUserAvalilabilityWithUserIDRequest
	2, // 4: user.AuthService.UserData:input_type -> user.UserDataRequest
	4, // 5: user.AuthService.CheckUserAvalilabilityWithTagUserID:input_type -> user.CheckUserAvalilabilityWithTagUserIDRequest
	7, // 6: user.AuthService.GetUserNameWithTagUserID:input_type -> user.GetUserNameWithTagUserIDRequest
	1, // 7: user.AuthService.CheckUserAvalilabilityWithUserID:output_type -> user.CheckUserAvalilabilityWithUserIDResponse
	3, // 8: user.AuthService.UserData:output_type -> user.UserDataResponse
	6, // 9: user.AuthService.CheckUserAvalilabilityWithTagUserID:output_type -> user.CheckUserAvalilabilityWithTagUserIDResponse
	9, // 10: user.AuthService.GetUserNameWithTagUserID:output_type -> user.GetUserNameWithTagUserIDResponse
