...
// func (ch *ChatClient) SaveMessage(chatId primitive.ObjectID, senderId int, message string) (primitive.ObjectID, error) {
...
// func (ch *ChatClient) ReadMessage(userId int, chatId primitive.ObjectID) (int64, error) {
...
// 	return data.Id, nil
// }
// func (ch *ChatClient) FetchRecipient(chatId primitive.ObjectID, userId int) (uint, error) {
